...
- 🛒 AI-driven inventory management with TensorFlow.  
- 🤖 Exploring transformers (BERT, GPT, ViT) for NLP & vision tasks.  
- 🎯 Fine-tuning models for domain-specific NLP & image recognition.  
